defmodule StructuredIO.Behaviour do
  ...
  @callback enumerate_with(structured_io :: GenServer.server,
                           ...
                           operation :: StructuredIO.operation) :: Enumerator.t
  ...
  """
  @since "1.1.0"
  @callback read(structured_io :: GenServer.server,
                 count_or_match :: StructuredIO.count | StructuredIO.match,
                 timeout :: timeout) :: StructuredIO.match | StructuredIO.error
  ...
  """
  @since "0.1.0"
  @callback read_across(structured_io :: GenServer.server,
                        left :: StructuredIO.left,
                        right :: StructuredIO.right,
                        timeout :: timeout) :: StructuredIO.match |
                                               StructuredIO.error
  ...
  """
  @since "0.7.0"
  @callback read_across_ignoring_overlap(structured_io :: GenServer.server,
                                         left :: StructuredIO.left,
                                         right :: StructuredIO.right,
                                         timeout :: timeout) :: StructuredIO.match |
                                                                StructuredIO.error
  ...
  """
  @since "0.2.0"
  @callback read_between(structured_io :: GenServer.server,
                         left :: StructuredIO.left,
                         right :: StructuredIO.right,
                         timeout :: timeout) :: StructuredIO.match |
                                                StructuredIO.error
  ...
  """
  @since "0.7.0"
  @callback read_between_ignoring_overlap(structured_io :: GenServer.server,
                                          left :: StructuredIO.left,
                                          right :: StructuredIO.right,
                                          timeout :: timeout) :: StructuredIO.match |
                                                                 StructuredIO.error
  ...
  """
  @since "1.2.0"
  @callback read_complex(structured_io :: GenServer.server,
  ...
  """
  @since "0.2.0"
  @callback read_through(structured_io :: GenServer.server,
                         right :: StructuredIO.right,
                         timeout :: timeout) :: StructuredIO.match |
                                                StructuredIO.error
  ...
  """
  @since "0.2.0"
  @callback read_to(structured_io :: GenServer.server,
                    right :: StructuredIO.right,
                    timeout :: timeout) :: StructuredIO.match |
                                           StructuredIO.error
  ...
  """
  @since "0.5.0"
  @callback start(mode :: StructuredIO.mode,
                  options :: GenServer.options) :: GenServer.on_start
  ...
  """
  @since "0.5.0"
  @callback start_link(mode :: StructuredIO.mode,
                       options :: GenServer.options) :: GenServer.on_start
  ...
  """
  @since "0.1.0"
  @callback stop(structured_io :: GenServer.server,
                 reason :: term,
                 timeout :: timeout) :: :ok
  ...
  """
  @since "0.1.0"
  @callback write(structured_io :: GenServer.server,
                  data :: iodata      |
                          IO.chardata |
                          String.Chars.t) :: :ok | StructuredIO.error
end
